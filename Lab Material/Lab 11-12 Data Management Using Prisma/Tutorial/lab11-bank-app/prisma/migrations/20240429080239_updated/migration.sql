/*
  ...
  - Added the required column `balance2` to the `Account` table without a default value. This is not possible if the table is not empty.
  - Added the required column `email2` to the `Owner` table without a default value. This is not possible if the table is not empty.
  - Added the required column `amount2` to the `Transaction` table without a default value. This is not possible if the table is not empty.
